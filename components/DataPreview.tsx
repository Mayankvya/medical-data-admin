...
//       // Split data into chunks of 400 records
...
//         // Add a short delay to prevent overloading the server
...
//       onUploadComplete();
//     } catch (err) {
//       setError('Error uploading data: ' + (err instanceof Error ? err.message : String(err)));
//     } finally {
//       setUploading(false);
//     }
//   };
...
//         <p className="text-gray-700">Chunk size: 400 records</p>
//         <p className="text-gray-700">Total chunks: {Math.ceil(data.length / 400)}</p>
//       </div>
...
//         {data.length === 0 && (
//           <p className="text-gray-500 mt-2 text-center">No records available</p>
//         )}
//       </div>
...
//       {error && (
//         <div className="mt-4 p-2 bg-red-50 text-red-700 rounded-md">{error}</div>
//       )}
